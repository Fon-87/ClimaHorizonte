...
Aplicación web desarrollada en **PHP 8.4** y **Laravel 12.3** que permite consultar el tiempo en cualquier ciudad mediante la API [apiweather.com](https://apiweather.com).  
